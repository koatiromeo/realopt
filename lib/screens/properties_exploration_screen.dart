...
class PropertiesExplorationScreen extends StatefulWidget {
  const PropertiesExplorationScreen({super.key});

  @override
  State<PropertiesExplorationScreen> createState() => _PropertiesExplorationScreenState();
}

class _PropertiesExplorationScreenState extends State<PropertiesExplorationScreen> {
                ...
                child: SafeArea(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        HeaderAdminOptions(mainTitle: 'Properties', subTitle: "Add, Edit, Remove \nand Compare",),
                        const SizedBox(
                          height: 30,
                        ),
                        TextField(
