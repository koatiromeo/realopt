...
class RecommendationsExplorationScreen extends StatefulWidget {
  const RecommendationsExplorationScreen({super.key});

  @override
  State<RecommendationsExplorationScreen> createState() => _RecommendationsExplorationScreenState();
}

class _RecommendationsExplorationScreenState extends State<RecommendationsExplorationScreen> {
