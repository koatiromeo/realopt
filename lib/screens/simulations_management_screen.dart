...
class SimulationsManagementScreen extends StatefulWidget {
  const SimulationsManagementScreen({super.key});

  @override
  State<SimulationsManagementScreen> createState() => _SimulationsManagementScreenState();
}

class _SimulationsManagementScreenState extends State<SimulationsManagementScreen> {
                ...
                child: SafeArea(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        HeaderAdminAdd(mainTitle: 'Simulations', subTitle: "Add, Edit, Remove",),
                        const SizedBox(
                          height: 30,
                        ),
                        TextField(
