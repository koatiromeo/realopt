...
class InvestorsProfilesManagementScreen extends StatefulWidget {
  const InvestorsProfilesManagementScreen({super.key});

  @override
  State<InvestorsProfilesManagementScreen> createState() => _InvestorsProfilesManagementScreenState();
}

class _InvestorsProfilesManagementScreenState extends State<InvestorsProfilesManagementScreen> {
                ...
                child: SafeArea(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        HeaderAdminAdd(mainTitle: 'Investors', subTitle: "Add, Edit, Remove",),
                        const SizedBox(
                          height: 30,
                        ),
                        TextField(
