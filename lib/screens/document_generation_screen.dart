...
class DocumentGenerationScreen extends StatefulWidget {
  const DocumentGenerationScreen({super.key});

  @override
  State<DocumentGenerationScreen> createState() => _DocumentGenerationScreenState();
}
            ...
            Align(
              ...
              child: Padding(
                ...
                child: TextButton(
                  ...
                  child: Text(isSwitchPreview ? 'Switch to Editor' : "Switch to PDF", style: TextStyle(color: Colors.white)),
                ),
              ),
            ),
          ],
                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      title: Text('Can the tenant assess the condition of the accommodation ? : Yes', style: TextStyle(color: Colors.white)),
                    ),
                    ListTile(
                      leading: Icon(Icons.question_mark_sharp, color: Colors.white),
                      title: Text('Can the tenant assess the condition of the accommodation ? : No', style: TextStyle(color: Colors.white)),
                    ),
                  ],
                ),
              ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      Text(
                        'Is a twenty-four hour notice given to the tenant before any visit to the housing unless in case of emergency ?',
                        style: TextStyle(color: Colors.white),
                      ),
                      SizedBox(height: 10),
                      Row(
