...
class _CompleteProfileScreenState extends State<CompleteProfileScreen> {
  ...
  @override
  void dispose() {
    PhoneFocusNode.removeListener(_handleFocusChange);
    PhoneFocusNode.dispose();
    _controllerPhoneEditing.dispose();
    super.dispose();
  }
                                        ...
                                        if(isPhoneValidated)
                                        {
                                          ...
                                          if(requestAsWork)
                                          {
                                            if(_SelectedTypeUser == "broker"){
                                              ...
                                              //         type: PageTransitionType.rightToLeft,
                                              //         duration: const Duration(milliseconds: 400),
                                              //         child: CompleteInvestorProfilePage(theemail: widget.theemail)));
                                    ...
                                    onPressed: () {
                                      if(_formkey.currentState!.validate())
                                      {
                                        if (_UserPhoneNumber.isEmpty) {
                                          setState(() {
                                            _errorPhoneText = "Can't be empty";
                                          });
                                        }
